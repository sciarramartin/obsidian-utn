...
```mermaid
graph TD
    A[1. PTM / MTP<br/>Propósito Masivo] --> B[2. Acuerdos de Equipo<br/>Valores y Reglas]
    B --> C[3. Tipo de Mercado<br/>Existente / Resegmentado / Nuevo / Clon]
    C --> D[4. Tecnologías Exponenciales<br/>IA, IoT, Drones, etc.]
    D --> E[5. Business Model Canvas<br/>9 Bloques + Caso Airbnb]
    E --> F[6. Value Proposition Canvas<br/>Customer Profile vs Value Map]
    F --> G[7. Métricas & MVP<br/>Validación de Problema]
```
