# 🟣 Hub: Integración de Aplicaciones en Entorno Web (IAEW)

**MOC Principal:** [[00_Indice_Maestro|Mi Segundo Cerebro]]  
**Tags:** #hub #materia/iaew #utn #sistemas #apis #seguridad  

---

## 🧭 Ejes Temáticos de la Materia

### 🧠 1. Conceptos y Protocolos de Integración
...
### 🛡️ 2. Seguridad, Identidad y Autenticación
...
* [[2026-08-20_conclusion_y_glosario_maestro_jwt_keycloak|Conclusión y Glosario Maestro: JWT y Keycloak]]
...
* [[2026-08-10_modalidad_academica_iaew_2026|Modalidad Académica IAEW 2026]]
* [[2026-08-13_credenciales_consola_aim|Credenciales y Acceso a Consola AIM]]
* [[2026-08-20_guia_trabajo_jwt_keycloak|Práctico JWT y Keycloak]]
* [[2026-08-20_instructivo_laboratorio_jwt_keycloak|Instructivo Paso a Paso: Laboratorio Keycloak]]
...
## 📋 Lista de Notas de IAEW (Dataview)

```dataview
TABLE file.mtime as "Modificado"
FROM ""
WHERE contains(file.tags, "iaew")
